CREATE TABLE "public"."country" ("id" serial NOT NULL, "created_at" timestamptz NOT NULL DEFAULT now(), "updated_at" timestamptz NOT NULL DEFAULT now(), "name" varchar NOT NULL, "name_pt" varchar NOT NULL, "initials" varchar NULL, "bacen" integer NOT NULL, PRIMARY KEY ("id") , UNIQUE ("id"));
...
INSERT INTO "public"."country" (id, name, name_pt, initials, bacen) VALUES
